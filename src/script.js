...
const material = new THREE.ShaderMaterial({
    ...
    uniforms:
    {
        ...
        uShadowRepeatations: new THREE.Uniform(100),
        uShadowColor: new THREE.Uniform(new THREE.Color(materialParameters.shadowColor)),
        uLightRepeatations: new THREE.Uniform(130),
...
gui.add(material.uniforms.uShadowRepeatations, 'value').min(1).max(300).step(1)
gui.add(material.uniforms.uLightRepeatations, 'value').min(1).max(300).step(1)
